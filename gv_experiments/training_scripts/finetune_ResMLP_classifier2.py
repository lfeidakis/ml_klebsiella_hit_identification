...
def main(args):
    ...
    finetune_folder = f"ResMLP_{sample_spectra_type}_{args.drug_emb_type}_{args.fingerprint_class}_pretrained_on:{args.pretrain_dataset}_finetuned_on:{args.finetune_dataset}_for_{args.n_epochs}_epochs"
...
if __name__=="__main__":
    ...
    parser.add_argument("--spectra_matrix", type=str,
                        default="/Users/lfeidakis/Desktop/MultimodalAMR-main-updated/ABCD/rawSpectra_data.npy")
    ...
    parser.add_argument("--ckpt_path", type=str, 
                        default="//Users/lfeidakis/Desktop/MultimodalAMR-main-updated/ABCD/ResultsAndCheckpoints/ABCD/raw_fing/new_loader_rawMS_fing_ABCD_DRIAMS-any_specific/0/lightning_logs/version_0/checkpoints/epoch=99-step=394700.ckpt")
    parser.add_argument("--config_path", type=str,
                        default="/Users/lfeidakis/Desktop/MultimodalAMR-main-updated/ABCD/ResultsAndCheckpoints/ABCD/raw_fing/new_loader_rawMS_fing_ABCD_DRIAMS-any_specific/config.json")
    ...
    args.num_workers = min(os.cpu_count(), 4)
