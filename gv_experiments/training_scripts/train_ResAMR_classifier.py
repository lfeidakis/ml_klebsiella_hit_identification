...
def main(args):
    ...
    with open(join(results_folder, f"losses_seed{seed}.json"), "w") as f:
...
if __name__=="__main__":
    ...
    parser.add_argument("--split_ids",type=str, default="/Users/lfeidakis/Desktop/MultimodalAMR-main-updated/B2018/data_splits.csv")
    ###

    parser.add_argument("--training_setup", type=int)
    parser.add_argument("--eval_importance", action="store_true", default=False)
    ...
    parser.add_argument("--driams_long_table", type=str,
                        default="/Users/lfeidakis/Desktop/MultimodalAMR-main-updated/processed_data/DRIAMS_combined_long_table.csv")
    parser.add_argument("--spectra_matrix", type=str,
                        default="/Users/lfeidakis/Desktop/MultimodalAMR-main-updated/B2018/maskedAE_copy10_batch50_embSize512_epoch100_MR25_data.npy")
