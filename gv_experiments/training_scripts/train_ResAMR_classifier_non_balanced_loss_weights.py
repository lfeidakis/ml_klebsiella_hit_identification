...
def main(args):
    ...
    with open(join(results_folder, f"metrics_seed{seed}.json"), "w") as f:
...
if __name__=="__main__":
    ...
    parser.add_argument("--spectra_matrix", type=str, default="/Users/lfeidakis/Desktop/MultimodalAMR-main-updated/ABCD/maskedAE_copy10_batch50_embSize512_epoch100_MR25_data.npy")
    ...
    parser.add_argument("--sample_embedding_dim", type=int, default=2048)
    ...
    parser.add_argument("--fingerprint_size", type=int, default=768)
